...
public class Product {
	...
	con.close();
	output = "Product Inserted successfull!";
	}
	catch (Exception e)
	{
	output = "Error! Please check inserted the product.";
	...
	Connection con = connect();
	if (con == null)
	{return "Error! Cannot connecting to the database for reading."; }
	...
	Connection con = connect();
	if (con == null)
	{return "Error! Cannot connecting to the database for updating."; }
	// create a prepared statement
	...
	{
	output = "Error! Please Check updated the product.";
	System.err.println(e.getMessage());
	}
	return output;
	}
	...
	{
	output = "Error! Please Check deleted the product.";
	System.err.println(e.getMessage());
	}
	return output;
	}
